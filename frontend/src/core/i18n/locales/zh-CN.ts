...
export const zhCN: Translations = {
  ...
  overview: {
    title: "总览",
    description: "运行健康、资源、模型与自动化工作负载一览。",
    runtime: "运行时",
    service: "服务",
    version: "版本",
    uptime: "运行时间",
    ...
    models: "模型",
    manage: "管理",
    noModels: "尚未配置模型——运行安装向导以添加。",
    moreModels: (count) => `另有 ${count} 个`,
    activity: "活动",
    runs: "运行次数",
    activeRuns: "进行中",
    threads: "对话",
    tokens: "Token",
    cost: "预估费用",
    statsUnavailable: "运行统计需要 SQL 数据库后端。",
    recentRuns: "最近运行",
    noRuns: "暂无运行记录。",
    resume: "继续",
    resuming: "继续中…",
    resumeFailed: "无法继续此次运行。",
    scheduledTasks: "定时任务",
    total: "总数",
    enabledCount: "生效中",
    team: "团队",
  ...
  workspace: {
    ...
    networkOffline: "网络已断开。工作已暂停，不会丢失。",
    networkOfflineResume: "重新连接后将自动恢复。",
    modelLoadFailed:
  ...
  settings: {
    ...
    rules: {
      title: "项目规则",
      description: "保存在工作区设置中的自定义指令。Hook 支持上线后，智能体将自动采用这些规则。",
      empty: "暂无规则。添加您希望智能体遵守的约定。",
      addRule: "添加规则",
      ruleTitlePlaceholder: "规则标题",
      ruleContentPlaceholder: "规则内容",
      ruleEnabled: "启用规则",
      deleteRule: "删除",
      emptyRule: "请先填写规则标题或内容。",
    },
    memory: {
      title: "记忆",
      description:
  ...
  "mcpServers": {
    ...
    skills: {
      ...
      proposalsTitle: "技能提案",
      proposalsDescription: "在生效前审核智能体提议的技能。批准后将安装到提议者的自定义技能中。",
      proposalsEmpty: "暂无提案。智能体提议的新技能将在此处等待审核。",
      proposalApprove: "批准并安装",
      proposalReject: "拒绝",
      proposalRejectReason: "原因（可选）",
      proposalRejectConfirm: "确认拒绝",
      proposalCancel: "取消",
      proposalApproved: "提案已批准并安装。",
      proposalRejected: "已拒绝该提案。",
      proposalReviewFailed: "审核失败，请重试。",
      proposalStatusPending: "待审核",
      proposalStatusApproved: "已批准",
      proposalStatusRejected: "已拒绝",
      proposalStatusInstalled: "已安装",
    },
    notification: {
      title: "通知",
      description:
    ...
    desktop: {
      title: "桌面端",
      description: "Windows 桌面端选项，仅在已安装的 DeerFlow 应用内生效。",
      autoStart: "开机自启动",
      autoStartHint:
        "登录 Windows 后自动启动 DeerFlow，定时任务与智能体运行时无需手动打开应用即可持续工作。",
      browserOnly: "桌面端选项仅在已安装的 Windows 应用内显示。",
      installedOnly: "开机自启动需要已安装的应用（源码运行模式下不可用）。",
      updateFailed: "无法更新开机启动设置，请重试。",
    },
    account: {
      profileTitle: "个人信息",
      email: "邮箱",
