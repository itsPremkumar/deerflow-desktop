...
export const enUS: Translations = {
  ...
  overview: {
    title: "Overview",
    description: "Runtime health, resources, models, and autonomous workload at a glance.",
    runtime: "Runtime",
    service: "Service",
    version: "Version",
    uptime: "Uptime",
    ...
    diskFree: "Disk free / total",
    models: "Models",
    manage: "Manage",
    noModels: "No models configured yet — run setup to add one.",
    ...
    tokens: "Tokens",
    cost: "Est. cost",
    statsUnavailable: "Run statistics need a SQL database backend.",
    recentRuns: "Recent runs",
    noRuns: "No runs recorded yet.",
    resume: "Resume",
    resuming: "Resuming…",
    resumeFailed: "Could not resume this run.",
    scheduledTasks: "Scheduled tasks",
    total: "Total",
    enabledCount: "Active",
    team: "Team",
  ...
  workspace: {
    ...
    logout: "Log out",
      ...
      networkOffline: "Network disconnected. Work is paused, not lost.",
      networkOfflineResume: "Reconnect to resume automatically.",
    modelLoadFailed:
  ...
  settings: {
    ...
    rules: {
      title: "Project rules",
      description:
        "Custom instructions kept with your workspace settings. Agents pick them up automatically once hook support lands.",
      empty: "No rules yet. Add the conventions you want agents to follow.",
      addRule: "Add rule",
      ruleTitlePlaceholder: "Rule title",
      ruleContentPlaceholder: "Rule content",
      ruleEnabled: "Rule enabled",
      deleteRule: "Delete",
      emptyRule: "Give the rule a title or content first.",
    },
    memory: {
      title: "Memory",
      description:
  ...
  "mcpServers": {
    ...
    skills: {
      ...
      proposalsDescription:
        "Review skills proposed by agents before they take effect. Approving installs into the proposer's custom skills.",
      proposalsEmpty: "No proposals yet. Agents propose new skills here for review.",
      proposalApprove: "Approve & install",
      proposalReject: "Reject",
      proposalRejectReason: "Reason (optional)",
      proposalRejectConfirm: "Confirm reject",
      proposalCancel: "Cancel",
      proposalApproved: "Proposal approved and installed.",
      proposalRejected: "Proposal rejected.",
      proposalReviewFailed: "Review failed. Try again.",
      proposalStatusPending: "Pending",
      proposalStatusApproved: "Approved",
      proposalStatusRejected: "Rejected",
      proposalStatusInstalled: "Installed",
    },
    notification: {
      title: "Notification",
      description:
    ...
    desktop: {
      title: "Desktop app",
      description:
        "Windows desktop options. These controls only work inside the installed DeerFlow app.",
      autoStart: "Start with Windows",
      autoStartHint:
        "Launch DeerFlow automatically when you sign in so scheduled tasks and the agent runtime keep running without opening the app first.",
      browserOnly: "Desktop options appear only inside the installed Windows app.",
      installedOnly:
        "Start with Windows needs the installed app (it is unavailable when running from sources).",
      updateFailed: "Could not update the startup setting. Please try again.",
    },
    account: {
